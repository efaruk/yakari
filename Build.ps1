...
Invoke-MSBuild -Path .\src\Yakari.sln

$revision = @{ $true = $env:APPVEYOR_BUILD_NUMBER; $false = 1 }[$env:APPVEYOR_BUILD_NUMBER -ne $NULL];
$revision = "{0:D4}" -f [convert]::ToInt32($revision, 10)

#exec { & dotnet test .\src\Yakari.Tests -c Release }

exec { & dotnet pack .\src\Yakari -c Release -o .\artifacts --version-suffix=$revision }
