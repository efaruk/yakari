...
namespace Yakari.Core.Demo
{
    public class DemoDependencyContainer : IDependencyContainer<ServiceContainer>
    {
        ...
        readonly string _connectionString = $"{DemoHelper.Configuration["redis"]},abortConnect=false,defaultDatabase=1,keepAlive=300,resolveDns=false,synctimeout=5000";
